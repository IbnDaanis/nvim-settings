...
vim.o.splitbelow      = true                        --- Horizontal splits will automatically below 
...
vim.o.undodir         = os.getenv("HOME") .. "/.config/nvim/undos"      --- Directory for undos
vim.o.undofile        = true                        --- Sets undo to file
vim.o.incsearch       = true                        --- Start searching before pressing enter
vim.o.hlsearch				= false                       --- Highlights whilst searching
...
vim.o.scrolloff       = 20                          --- Always keep space when scrolling to bottom/top edge
